...
def nullTransform(df):
    ...
    essential_columns = ["start_date", "end_date", "latitud", "longitud", "property_surface_total", "property_price", "property_currency"]
    ...
    if not rows_with_na_bedrooms.empty:
        Logger.logWarning("Las siguientes filas fueron imputadas con un nuevo valor en property_rooms:", df3.loc[rows_with_na_bedrooms, 'property_bedrooms'])
